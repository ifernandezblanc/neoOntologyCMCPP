...
pkt1:
	...
	if (ping1 == 1)
	{
		try
		{
			...
			strcat(ping2, "[");
			strcat(ping2, "{\"ontName\":\"http://138.250.108.1:3003/api/files/owl/diagont#hasMeasureValue\",\"ontValue\":\"");
			strcat(ping2, "0");
			strcat(ping2, "\",");
			...
			strcat(ping2, "{\"ontName\":\"http://138.250.108.1:3003/api/files/owl/diagont#hasMeasureDate\",\"ontValue\":\"");
			strcat(ping2, date);
			strcat(ping2, "\",");
			...
			strcat(ping2, "{\"ontName\":\"http://138.250.108.1:3003/api/files/owl/diagont#hasMeasureUnit\",\"ontValue\":\"http://138.250.108.1:3003/api/files/owl/diagont#second\",\"ontDomain\":\"http://138.250.108.1:3003/api/files/owl/diagont#State\",\"ontRange\":\"http://138.250.108.1:3003/api/files/owl/diagont#Unit\",\"ontType\": \"http://www.w3.org/2002/07/owl#ObjectProperty\"},");
...
pkt4:
	...
	try
	{
		...
		strcat(ping2, "\",");
		strcat(ping2, "\"ontDomain\":\"http://138.250.108.1:3003/api/files/owl/diagont#State\",\"ontRange\":\"http://www.w3.org/2001/XMLSchema#dateTime\",\"ontType\": \"http://www.w3.org/2002/07/owl#DatatypeProperty\"},");
		strcat(ping2, "{\"ontName\":\"http://138.250.108.1:3003/api/files/owl/diagont#hasMeasureUnit\",\"ontValue\":\"http://138.250.108.1:3003/api/files/owl/diagont#degreeCelsius\",\"ontDomain\":\"http://138.250.108.1:3003/api/files/owl/diagont#State\",\"ontRange\":\"http://138.250.108.1:3003/api/files/owl/diagont#Unit\",\"ontType\": \"http://www.w3.org/2002/07/owl#ObjectProperty\"},");
